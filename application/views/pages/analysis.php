            ...
            <div class="box">
              ...
              <div class="box-body">
                <table class="table table-bordered">
                  ...
                  <?php
                  $no = 0;
                  $sql = $this->Crud->query("SELECT * FROM `enum` WHERE `enum`.`type` = 'analysis' AND `enum`.`device_id` = '{$value['id']}' ORDER BY `alias` ASC");
                  foreach ($sql as $data) {
                    $no++;
                ...
                <!-- form start -->
                <form role="form" method="post" action="<?php echo base_url('Save/enum/analysis');?>">
                  <div class="box-body">
