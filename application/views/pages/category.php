            ...
            <div class="box">
              ...
              <div class="box-body">
                <table class="table table-bordered">
                  ...
                  <?php
                  $no = 0;
                  $sql = $this->Crud->search('enum', array('enum.type' => 'category', 'enum.device_id' => $value['id']))->result_array();
                  foreach ($sql as $data) {
                    $no++;
                ...
                <!-- form start -->
                <form role="form" method="post" action="<?php echo base_url('Save/enum/category');?>">
                  <div class="box-body">
