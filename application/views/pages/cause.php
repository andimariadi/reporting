  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Cause By Problem</li>
      </ol>
    </section>
            ...
            <div class="box">
              ...
              <div class="box-body">
                <table class="table table-bordered">
                  ...
                  <?php
                  $no = 0;
                  $sql = $this->Crud->query("SELECT * FROM `enum` WHERE `enum`.`type` = 'cause' AND `enum`.`device_id` = '{$value['id']}' ORDER BY `alias` ASC");
                  foreach ($sql as $data) {
                    $no++;
                ...
                <!-- form start -->
                <form role="form" method="post" action="<?php echo base_url('Save/enum/cause');?>">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label>Alias</label>
                      <input class="form-control" name="alias" placeholder="Type here" type="text" required autocomplete="off">
                    </div>
                  </div>
                  <!-- /.box-body -->
